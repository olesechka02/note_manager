...
additional_title1 = int(input('Добавить дополнительный заголовок? (Если да, то введите "1", если нет, то "0"): '))
if additional_title1 == 1:
   additional_title_new = input('Введите дополнительный заголовок: ')
...
titles = [title1]
if additional_title1 == 1:
        titles.append(additional_title_new)
...
if additional_title1 == 1:
    ...
    print('Второй заголовок: ', additional_title_new)
    if additional_title2 == 1:
        print('Третий заголовок: ', additional_title_new2)
else:
